...
urlpatterns = [
    ...
    path('nurse-supt/pending/', views.nurse_supt_approvals, name='nurse_supt_approvals'),
    path('nurse-supt/action/<int:pk>/', views.nurse_supt_action, name='nurse_supt_action'),
    ...
    path('ceo/action/<int:pk>/', views.ceo_action, name='ceo_action'),
